...
import com.spring.dao.StudentMarksTransactionDAO;
 ...
 *
 */
public class StudentMarksJDBCTemplate implements StudentMarksTransactionDAO {
	...
	public void create(String name, Integer age, Integer marks, String subject,
		...
		System.out
				.println("DefaultTransactionDefinition **********************"
						+ def.getName() + " " + def.getIsolationLevel() + " "
						+ def.getPropagationBehavior() + " " + def.getTimeout());
		
		TransactionStatus trsStatus = transactionManager.getTransaction(def);
		System.out.println(this.getClass() + " trsStatus..... "
				+ trsStatus.isCompleted());
		...
		try {
			...
			transactionManager.commit(trsStatus);

		} catch (Exception e) {
			System.out.println(this.getClass()
					+ " Error in creating transaction..... " + e);
			transactionManager.rollback(trsStatus);
		} finally {
	...
	public void createTable() {
		...
		System.out.println(StudentJDBCTemplate.class + "Table Created..... "
			...
			System.out.println(StudentJDBCTemplate.class + "Table Already exists..... "
					);
		}
		
		String sql = "create table Student_Marks"
				+ " ( ID INT NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1,INCREMENT BY 1), "
	...
	public void deleteTable() {
		...
		System.out.println(StudentJDBCTemplate.class + "Table Dropped..... "
			...
			System.out.println(StudentJDBCTemplate.class + "Table can't be dropped..... "
					);
		}
