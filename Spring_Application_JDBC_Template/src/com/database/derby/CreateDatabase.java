...
public class CreateDatabase {
	...
	private final static String CREATE_EMPLOYEE = "create table Employee"
			...
			+ "NAME VARCHAR(100) NOT NULL, " + "DATE_OF_JOIN DATE NOT NULL, " + "DATE_OF_BIRTH DATE NOT NULL, "
	...
	private final static String CREATE_DEPARTMENT = "create table Department"
			+ " ( ID INT NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1,INCREMENT BY 1), "
			+ "NAME VARCHAR(100) NOT NULL, " + "DESCRIPTION VARCHAR(120) NOT NULL, " + "PRIMARY KEY (ID) )";
